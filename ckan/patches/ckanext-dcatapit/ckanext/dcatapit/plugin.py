...
from ckanext.dcatapit.helpers import get_org_context, dcatapit_string_to_aggregated_themes
...
#    plugins.implements(plugins.IRoutes, inherit=True)
    ...
    def get_validators(self):
        return {
            ...
            'dcatapit_holder': validators.dcatapit_holder,
...
#        if len(extra_theme)>4:
    ...
    def after_dataset_search(self, search_results, search_params):
        ...
        #log.debug('search_results in plugin %s',facets)
    ...
    def dataset_facets(self, facets_dict, package_type):
        ...
        #facets_dict['resource_license_{}'.format(lang)] = 'Licenza prova'
        #facets_dict['dcat_theme'] = 'Economia prova'
        #facets_dict['dcat_subtheme_{}'.format(lang)] = 'Sottotema prova'
